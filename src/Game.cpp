...
SDL_AppResult Game::init()
{
    ...
    Uint32 window_flags = SDL_WINDOW_OPENGL | SDL_WINDOW_HIDDEN /*| SDL_WINDOW_RESIZABLE | SDL_WINDOW_HIDDEN */;
    SDL_CreateWindowAndRenderer(name.data(), screenWidth, screenHeight, window_flags, &wHandle, &rHandle);
    ...
    SDL_GetBasePath(); // Cache internally
